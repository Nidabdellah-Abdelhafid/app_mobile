        ...
        <View style={styles.container}>
            ...
            <TouchableOpacity onPress={openModal}>
                <View style={styles.searchBar}>
                    <Ionicons name="search" color="#000" size={25} style={{ marginRight: 17 }} />
                    <View>
                        <Text style={{ fontSize: 17, color: '#000', fontWeight: '700' ,fontFamily: 'Roboto'}}>Distination</Text>
                        <Text style={{ fontSize: 11, color: '#666' ,fontFamily: 'Roboto'}}>N'importe ou - Une semaine - Ajouter des invités</Text>
                    </View>
            ...
            <TouchableOpacity onPress={openModal1}>
                <View style={styles.searchBarbtn}>
                    <FontAwesome6 name="sliders" size={17} color="black" />
                </View>
            </TouchableOpacity>
            </View>
            <Modal
            ...
            >
                <View style={styles.centeredView}>
                    <View style={styles.modalView}>
                        <Button title="Select Date 1" onPress={() => handleDateSelect1(new Date())} />
                    </View>
                </View>
            </Modal>
